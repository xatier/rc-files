...
pep8-check() {
    # pip install flake8 flake8-annotations flake8-bugbear flake8-comprehensions flake8-docstrings flake8-import-order flake8-return pep8-naming
    # optionals:
    # flake8-annotations-complexity flake8-annotations-coverage flake8-broken-line
    # flake8-class-attributes-order flake8-commas flake8-expression-complexity
    # flake8-pytest-style flake8-simplify flake8-variables-names
    source "$HOME/work/pip/bin/activate"
